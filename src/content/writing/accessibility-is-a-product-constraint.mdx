...
A heading that is actually an `h2`, a button that is actually a `button`, and a nav that is actually a `nav` do more than make your code look good. They give keyboards, screen readers, and browsers a map.
